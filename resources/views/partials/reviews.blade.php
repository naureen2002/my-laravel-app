...
<section class="page-section" id="reviews">
    <div class="container">
        ...
        <div class="row g-4">
            @foreach ([
                ['quote' => 'Cyberlog stood up our SOC in a week and cut our alert noise dramatically. We finally have real visibility.', 'name' => 'CISO, Financial Institution', 'badge' => 'High Performer'],
